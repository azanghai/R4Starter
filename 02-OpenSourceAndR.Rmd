...
如果您遇到了网络访问问题，也可以通过这个飞书链接下载我们预下载的[Windows版本的R](https://cyouthchange.feishu.cn/file/TEuOb4ymMoJWVaxeQqlceBIfncc?from=from_copylink)和[MacOs版本的R Apple silicon (M1/M2)](https://cyouthchange.feishu.cn/file/AN05bjiPWoHlnBxZZpzconGgnCc?from=from_copylink)，[MacOs版本的R Intel Macs](https://cyouthchange.feishu.cn/file/UahJbk9LvopruNx0Zf4cwudvnbh?from=from_copylink)以及[Windows 10/11版本的RStudio Desktop](https://cyouthchange.feishu.cn/file/MWzDbnH02oj6uGx7qd0cNTkpnug?from=from_copylink)和[MacOs 12 + 版本的RStudio Desktop](https://cyouthchange.feishu.cn/file/T2lYb2tCyoHg7txTL30cZ5vPnwg?from=from_copylink)。
